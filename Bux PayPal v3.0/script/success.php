...
if (ereg('[^0-9]', $id)) {
echo "<script>alert('You were caught hacking! An email has been forwarded to the Administrator for further investigation.')</script>";
$ip = $_SERVER['REMOTE_ADDR'];
$email = $rowpp["sitepp"];
$subject = "User Caught Hacking";
mail($email,$subject,$ip);

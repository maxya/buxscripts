...
Site AlertPay:</th><td> <input type="text" name="sitepp" value="<?
...
<tr>
<th width="200">Each referral click:</th><td> $<input type="text" name="referalclick" value="<?
...
<tr>
<th width="200">Upgrade Price:</th><td> $<input type="text" name="upgrade" value="<?
...
<tr>
<th width="200">Each premium referral click:</th><td> $<input type="text" name="premiumreferalc" value="<?

...
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 1000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="1000 site Hits"/>  
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 2000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="2000 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 3000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="3000 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 5000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="5000 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 10000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="10000 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 500 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="500 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 20000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="20000 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 30000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="30000 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 50000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="50000 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<input type="hidden" name="ap_purchasetype" value="service"/>  
<input type="hidden" name="ap_merchant" value="<? include('alertpay.php'); ?>"/>  
<input type="hidden" name="ap_itemname" value="<? include('sitename.php'); ?> - 100000 site Hits"/>  
<input type="hidden" name="ap_currency" value="USD"/>  
<input type="hidden" name="ap_returnurl" value="<?= $url ?>"/>  
<input type="hidden" name="ap_itemcode" value="01"/>  
<input type="hidden" name="ap_quantity" value="1"/>  
<input type="hidden" name="ap_description" value="100000 site Hits"/>  
<input type="hidden" name="ap_amount" value="<?= $precio ?>"/>  
<input type="hidden" name="ap_cancelurl" value="<?= $url ?>"/>  
<input type="image" name="ap_image" src="https://www.alertpay.com/Images/BuyNow/big_pay_01.gif"/> 
</form>
...
<br><br>
<b>PLEASE</b> make sure that your server can support the amount of requests that your site will get. You will have no way of pausing or canceling your ad once it becomes active. <b>So we know which ad you paid for, please provide your AlertPay registered e-mail address so we can do a cross-reference.</b>
<br><br>
...
<table width="400" border="0" align="center">
  <tr>
    <td width="150" align="left"><p><label>AlertPay E-mail</label></p></td>

...
if ($_GET["option"]=="delete")
{
    ...
    echo "<font color=\"#cc0000\"><b>User удален.</b></font><br><br>";
}
...
//examino la pбgina a mostrar y el inicio del registro a mostrar
...
$uno = 1;
$mos = $uno + 1;
echo "<a href='index.php?op=7&pagina=$mos'><font face=\"verdana\" style=\"font-size:11px;\" color=\"#000000\"><b>следующая страница</b></font></a> ";
} else {

$mos = $uno + 1;

for ($z=$mos;$z<=$mos;$z++){
echo "<a href='index.php?op=7&pagina=$z'><font face=\"verdana\" style=\"font-size:11px;\" color=\"#000000\"><b>следующая страница</b></font></a> ";

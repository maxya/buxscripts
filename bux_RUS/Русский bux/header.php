...
<title><?php include('sitename.php');?> - Мы нашли способ заработать!</title>
</head>
<body>
...
?>
<div id="headline1">
<a href="/index.php"><div class="title"><?php include('sitename.php');?> - Мы нашли способ заработать</div></a>

...
$price=$_POST["price"];
    ...
    echo "<font color=\"green\"><b>Тарифные планы отредактированы.</b></font><br><br>";
...
if ($option=="delete"){
    ...
    echo "<font color=\"#cc0000\"><b>Тарифный план удален.</b></font><br><br>";
}

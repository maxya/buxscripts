...
<b>Заказ на покупку рефералов</b>
...
echo "Error. Нет ". $referals ." свободных пользователей.<br><br>";
...
?></b>
<br><br>
Когда Вы выталкиваете "Одобрять" это автоматически поместило referals asigned клиенту.
<br><br>
<table>
<tr>
<th>Клиент</th>
...
<input type="submit" value="отказать" class="button">
</form>
</td>
</tr>

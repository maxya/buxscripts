...
$highlight=$_POST["highlight"];
    ...
    echo "<font color=\"green\"><b>Ссылка добавлена.</b></font><br><br>";
...
WMID: <input type="text" name="pemail" value="<?= $registroe["paypalemail"] ?>"><br>
...
Описание: <input type="text" name="description" value="<?= $registroe["description"] ?>"><br>

Катигория: [<?= $registroe["category"] ?>]  -
...
<tr>
<td>". $registro["id"] ."</td>
<td ><a href=\"". $registro["url"] ."\" target=\"_blank\">Сайт</a></td>

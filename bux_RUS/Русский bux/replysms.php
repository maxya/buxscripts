...
echo "SECURITY CODE ERROR... <a href='replysms.php'> вернуться назад... </a>";
include('footer.php');
...
echo "<br><br><p>Ваше сообщение послало</p>";
include('footer.php');
?>
</font>
...
<fieldset>
<legend>&nbsp;Необходимо заполнить все поля&nbsp;</legend>
...
<table width="400" border="0" align="center">
  ...
  <tr>
    <td width="150" align="left">&nbsp;</td>
    <td width="250" align="right"><input type="submit" value="отправить" class="submit" tabindex="3" />
	</td>
  </tr>
</table>

...
if ($ip_exist>0) {
echo "Error: You have already created an account.";
}else{


// Comprobamos que el nombre de usuario, email y el email de AlertPay no existan
...
if ($pemail_exist>0) {
echo "Your AlertPay Address is Already in Use.";
}else{
...
echo "Error: The referrer you entered doesn't exist"; include('footer.php');exit();
}else{
...
5)	All payments are made via AlertPay and no other payment method is being used at this time. You must manually request for payment to be processed and it will be issued within 3 business days. You must accumulate at least $10 before payment will be issued. 

6)	You must have a valid e-mail address and valid AlertPay address to register with our program. All e-mail addresses are verified and the system will not let you join without validating at least your e-mail address first. A verification e-mail is sent to you upon registration.
...
9)	Advertising fees are to be paid via AlertPay only. AlertPay accepts all major credit cards, bank transfers and AlertPay funds.

...
<br><br>
<a href="convert.php?convert=cash"><b>Convert to Cash via AlertPay</b></a><br>
Get CASH via AlertPay. You must earn at least $<?
require('config.php'); 
...
echo "<center><b>Whoops, you only have $".$row["money"]." You must earn at least $".$price." to request payment via AlertPay.</b></center>";
